...
class ExcelController extends Controller
{
    ...
    {
        $candidate = $this->vote->getCandidateModel($id);
        $content = $this->behalf->getVoteDetail($candidate, $id);

        $this->title = ['代表姓名', '投票详情'];
        $this->filename = $this->sheetname = '投票详情结果';
       
        $this->behalf->exportModel($this->filename, $this->sheetname, 
                    $this->title, $this->letter, 'xlsx', $content);
