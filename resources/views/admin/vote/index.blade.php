        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <a href="{{ route('admin.excel.model.export', 1) }}">
                    <button class="btn btn-default">下载模版</button>
                </a>
                <a href="{{ route('admin.excel.export', $id) }}">
                    <button class="btn btn-default">导出结果</button>
                </a>
                <a href="{{ route('admin.clear.test', $id) }}">
                    <button class="btn btn-danger">清空测试数据</button>
                </a>
                <br><br>
                ...
                <table class="table table-bordered table-hover" 
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.todo_update',$v['id']) }}">修改</a>
                            <a href="{{ route('admin.todo_delete',$v['id']) }}"
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered table-hover" 
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.vote_todo_update',$v['id']) }}">修改</a>
                            <a href="{{ route('admin.vote_todo_delete',$v['id']) }}"
                               onclick="if (confirm('确定要删除吗？') == false) return false;">删除</a>
                        </td>
                    </tr>
                    @endforeach
