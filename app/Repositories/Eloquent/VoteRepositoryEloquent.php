 ...
 *//**
    ...
    /**
     * showCandidateVoteNum 实时查询票数
     * @author leekachung <leekachung17@gmail.com>
     * @param  [type] $id [description]
     * @return [type]     [description]
     */
    public function showCandidateVoteNum($id)
    {
        return $this->model->where([
                'vote_model_id' => $id,
                'is_waiting' => 0
        ])->orderBy('vote_num', 'desc')->get();
    }
    ...
    /**
     * getCandidateModel 生成id匹配候选人模版
     * @author leekachung <leekachung17@gmail.com>
     * @param  [type] $id [description]
     * @return [type]     [description]
     */
    public function getCandidateModel($id)
    {
        $candidate = $this->getCandidateList($id);
        $newArr = [];
