                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.vote.update', $id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('admin.editVotemodel_start',$id) }}">
                                <button type="button" class="btn btn-primary">开始投票</button></a>

                            <a href="{{ route ('admin.editVotemodel_end', $id)}} ">
                                <button type="button" class="btn btn-primary">停止投票</button></a>
